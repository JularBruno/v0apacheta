		...
		<div ref={pageRef} className={styles.page}>
			...
			<div className={styles.content}>
				...
				<header data-clear className="mx-auto max-w-2xl px-5 pb-10 pt-16 sm:px-6">
					...
					<Link
						href="/onboarding"
						className="inline-flex items-center gap-2 rounded-xl bg-accent px-6 py-3.5 text-base font-bold text-accent-foreground shadow-sm transition-opacity hover:opacity-90"
					>
						{HERO.cta}
						<ArrowRight />
					</Link>
