...
export default function TransactionDonutChart({ movements, categories }: TransactionDonutChartProps) {
	// Calculate spending by category (only gastos)
	//   const expenses = movements.filter((t) => t.type === TxType.EXPENSE);
			...
			<CardContent>
				<div className="grid grid-cols-1 gap-6">
                  ...
                  <div className="text-xs text-gray-400 mt-1">{overallBudgetPercentage.toFixed(0)}% usado</div> */}
									...
									<div className="text-xs text-gray-400 mt-1">{10}% usado</div>
								</div>
							</div>
