...
export default function TransactionChart() {
	...
	const expenses = budgetedCats.filter((t) => t.type === TxType.EXPENSE)
	const incomeTotalAllCats = budgetedCats.filter((t) => t.type === TxType.INCOME).reduce((sum, t) => sum + t.totalExpenses, 0)
	const totalExpensesAllCats = expenses.reduce((sum, t) => sum + t.totalExpenses, 0)

	const segments = budgetedCats
